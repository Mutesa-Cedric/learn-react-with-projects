            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div className="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-center sm:justify-center sm:w-3/4 sm:mx-auto">
                            <div className="mt-3 mb-2 text-start inline-flex flex-col sm:mt-2 sm:text-center">
                                ...
                                <div className="mt-2 inline-flex flex-col items-center justify-center">
