 ...
 function Info(){
    ...
    return(
        <div className="flex flex-col items-center">
            <img src={profileImg} className="w-full rounded-t-lg h-80" alt="Profile"></img>
            <div className="flex flex-col items-center w-full px-10">
                <h1 className="text-4xl mt-4  text-white">Mutesa Cedric</h1>
                <h3 className="text-xl text-[#F3BF99] capitalize">fullstack developer</h3>
                ...
                <button  className="bg-white text-2xl py-2 flex items-center justify-center w-full text-gray-700 rounded-lg hover:bg-[#d78547]">
                    ...
                    <a href="https://accounts.google.com/b/0/AddMailService" className="mx-3 pb-1">Email</a>
